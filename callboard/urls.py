...
from callboard.views import AdvertisementCreateAPIView, AdvertisementListAPIView, AdvertisementRetrieveAPIView, \
    AdvertisementUpdateAPIView, AdvertisementDestroyAPIView, CommentCreateAPIView, CommentListAPIView, \
